...
class EllipticCurve(object):
    ...
    def isPointValid(self, point):
        ...
        if point is None:  # Point à l'infini
            return True  # Le point est forcément valide

        return point[1] ** 2 % self.Fp == (
                    point[0] ** 3 + self.a * point[0] + self.b) % self.Fp  # Vérifie que le point est sur la courbe
    ...
    def addPoints(self, p1, p2):
        ...
        if p1 is None:  # Si p1 est le point à l'infini...
            return p2  # ...alors on renvoie l'autre point
        if p2 is None:  # Si p2 est le point à l'infini...
    ...
    def find_point_order(self, point):
        ...
        while current is not None:  # Tant que ca n'est pas le point à l'infini...
